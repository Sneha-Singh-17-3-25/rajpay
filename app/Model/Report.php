...
{
    protected $fillable = ['number','mobile','provider_id','api_id','amount','charge','profit','gst','tds','apitxnid','txnid','payid','refno','description','remark','option1','option2','option3','option4','option5','option6','option7','option8','option9', 'option10','status','user_id','credit_by','rtype','via','adminprofit','balance','trans_type','product','wid','wprofit','mdid','mdprofit','disid','disprofit','create_time'];
