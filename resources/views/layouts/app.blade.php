...
<head>
   ...
   <title>{{ $mydata['company']->companyname ?? 'Company Name' }}</title>
...
<link href="{{ asset('assets/css/icons/fontawesome/styles.min.css') }}" rel="stylesheet">
...
<link href="{{ asset('assets/js/plugins/materialToast/mdtoast.min.css') }}" rel="stylesheet">
...
<script src="{{ asset('assets/js/core/dropzone.js') }}"></script>
<script src="{{ asset('assets/js/core/jquery-confirm.min.js') }}"></script>
<script src="{{ asset('assets/js/plugins/materialToast/mdtoast.min.js') }}"></script>
