                        ...
                        <div class="col-md-10">
                            <div id="carouselExampleSlidesOnly" class="carousel slide bg-white p-3" data-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    @foreach($slides as $key => $slidess)
                                        @if($key == "0")
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="{{$slidess->value}}" style="width: 540; height: 475px;" alt="First slide">
                                            </div>
                                        @else
                    ...
                    <div class="row justify-content-center align-items-center py-3">
                        <div class="col-lg-8 col-md-10 mb-3">
                            <div class="text-left mb-3 text-center">
                                ...
                                <img src="{{ asset('public/' . $company->logo) }}" style="height: 70px;">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8 col-md-10">
                            ...
                            <form class="login100-form validate-form" id="login" method="POST" action="{{route('authCheck')}}" novalidate="">
                                ...
                                <div class="form-group first password-container">
                                    ...
                                    <input type="text" class="form-control" name="mobile" value="{{ old('mobile') }}" id="cmobile" placeholder="Enter username">
                                </div>
                                ...
                                <div class="d-flex mb-4 align-items-center justify-content-between pull-left">
                                    <div>
                                        <a href="{{ route('policy') }}" class="font-weight-bold text-black" id="">Privacy Policy</a>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 text-center">
                                    <p class="text-primary text-center">
                                        <strong>Help & Support</strong><br>{{$mydata['supportnumber'] ?? ''}}
                                    </p>
                                    <br>
