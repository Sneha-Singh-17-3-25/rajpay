            ...
            <div class="tab-content">
                            ...
                            <div class="panel-body p-b-0">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" {{ Myhelper::hasNotRole('admin') ? 'disabled=""' :'name=alternate_mobile'}} required="" value="{{$user->alternate_mobile}}" class="form-control" placeholder="Enter Value">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                ...
                <div class="tab-pane fade" id="kycdata">
                    <form id="kycForm" action="{{route('profileUpdate')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{$user->id}}">
                        <input type="hidden" name="actiontype" value="kycupdate">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title">Kyc Data</h5>
                                @if (Myhelper::hasRole('admin'))
                                    <div class="heading-elements">
                                        <a href="{{url("profile/download_kyc/")}}/{{$user->id}}">
                                            <button class="btn btn-warning btn-sm  pull-right btn-sm" type="button">Download Kyc</button>
                                        </a>
                                    </div>
                                @endif
                            </div>
                            <div class="panel-body p-b-0">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="shopaddress" class="form-control" rows="2" required="" placeholder="Enter Value">{{$user->shopaddress}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        @if ($user->pancardpic)
                                            <div class="thumbnail text-center">
                                                <input type="hidden" name="pancardpic" value="{{$user->pancardpic ?? ''}}">
                                                <a href="{{asset('public')}}/{{$user->pancardpic}}" target="_blank">
                                                    <img style="width: 200px; height: 150px" src="{{asset('public')}}/{{$user->pancardpic}}" alt="">
                                                    Self Attested Pancard Copy
                                                </a>

                                                @if (Myhelper::hasRole('admin'))
                                                    <button type="button" class="btn btn-danger btn-sm" onclick="reject('pancardpic')"> 
                                                        Reject
                                                    </button>
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        @if ($user->aadharcardpicfront)
                                            <div class="thumbnail text-center">
                                                <input type="hidden" name="aadharcardpicfront" value="{{$user->aadharcardpicfront ?? ''}}">
                                                <a href="{{asset('public')}}/{{$user->aadharcardpicfront}}" target="_blank">
                                                    <img style="width: 200px; height: 150px" src="{{asset('public')}}/{{$user->aadharcardpicfront}}" alt="">
                                                    Self Attedted E-Aadhar Copy
                                                </a>

                                                @if (Myhelper::hasRole('admin'))
                                                <button type="button" class="btn btn-danger btn-sm" onclick="reject('aadharcardpicfront')"> 
                                                    Reject
                                                </button>
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        @if ($user->profile)
                                            <div class="thumbnail text-center">
                                                ...
                                                <a href="{{asset('public')}}/{{$user->profile}}" target="_blank">
                                                    <img style="width: 200px; height: 150px" src="{{asset('public')}}/{{$user->profile}}" alt="">
                                                    Self photo Latest
                                                </a>
                                                @if (Myhelper::hasRole('admin'))
                                                <button type="button" class="btn btn-danger btn-sm" onclick="reject('profile')"> 
                                                    Reject
                                                </button>
                                                @endif
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        @if ($user->otherdoc)
                                            <div class="thumbnail text-center">
                                                <input type="hidden" name="otherdoc" value="{{$user->otherdoc ?? ''}}">
                                                <a href="{{asset('public')}}/{{$user->otherdoc}}" target="_blank">
                                                    <img style="width: 200px; height: 150px" src="{{asset('public')}}/{{$user->otherdoc}}" alt="">
                                                    Shop Outside Photo
                                                </a>

                                                @if (Myhelper::hasRole('admin'))
                                                <button type="button" class="btn btn-danger btn-sm" onclick="reject('otherdoc')"> 
                                                    Reject
                                                </button>
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        @if ($user->passbook)
                                            <div class="thumbnail text-center">
                                                <input type="hidden" name="passbook" value="{{$user->passbook ?? ''}}">
                                                <a href="{{asset('public')}}/{{$user->passbook}}" target="_blank">
                                                    <img style="width: 200px; height: 150px" src="{{asset('public')}}/{{$user->passbook}}" alt="">
                                                    Cancle Cheque/ Bank Passbook / Gst
                                                </a>
                                                @if (Myhelper::hasRole('admin'))
                                                <button type="button" class="btn btn-danger btn-sm" onclick="reject('passbook')"> 
                                                    Reject
                                                </button>
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        @if ($user->aadharcardpicback)
                                            <div class="thumbnail text-center">
                                                <input type="hidden" name="aadharcardpicback" value="{{$user->aadharcardpicback ?? ''}}">
                                                <a href="{{asset('public')}}/{{$user->aadharcardpicback}}" target="_blank">
                                                    <img style="width: 200px; height: 150px" src="{{asset('public')}}/{{$user->aadharcardpicback}}" alt="">
                                                    Video Kyc
                                                </a>

                                                @if (Myhelper::hasRole('admin'))
                                                <button type="button" class="btn btn-danger btn-sm" onclick="reject('aadharcardpicback')"> 
                                                    Reject
                                                </button>
                                                @endif
                                            </div>
                                ...
                                @if (Myhelper::hasRole('admin'))
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Kyc Submitted At</th>
                                                <th>Kyc Approved At</th>
                                                <th>Kyc Approved By</th>
                                            </tr>
                                            <tr>
                                                <th>{{$user->kyctime}}</th>
                                                <th>{{$user->kyc_approval_time}}</th>
                                                <th>{{$user->kyc_approved_by}}</th>
                                            </tr>
                                        </thead>
                                    </table>
                                @endif
                                ...
                                @if (Myhelper::can('member_kyc_update'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-8">
                                            <label>Remark</label>
                                            <textarea name="remark" class="form-control" rows="1" placeholder="Enter Remark">{{$user->remark}}</textarea>
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body p-b-0">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label>New Pin</label>
                                        <input type="password" minlength="4" maxlength="4" name="pin" id="pin" class="form-control" required="" placeholder="Enter Value">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Confirmed Pin</label>
                                        <input type="password" minlength="4" maxlength="4" name="pin_confirmation" class="form-control" required="" placeholder="Enter Value">
                                    </div>
                ...
                <div class="tab-pane fade" id="settings">
                    <form id="passwordForm" action="{{route('profileUpdate')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title pull-left">Password Reset</h5>
                                @if(Myhelper::hasRole('admin'))
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        @if (\Myhelper::hasRole('admin'))
            ...
            $('[name="kyc"]').select2().val('{{$user->kyc}}').trigger('change');
        @endif
    ...
    function reject(ele){
        $("[name='"+ele+"']").val("");
        $("[name='"+ele+"']").closest("div").find("img").attr("src", "");
    }
