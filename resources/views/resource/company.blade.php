                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <label>Name</label>
                            <input type="text" name="companyname" class="form-control" placeholder="Enter value" required="">
                        </div>
                        <div class="form-group col-md-12">
                            <label>Website</label>
                            <input type="text" name="website" class="form-control" placeholder="Enter value" required="">
                        </div>
                        <div class="form-group col-md-12">
                            <label>Company Code</label>
                            <input type="text" name="companycode" class="form-control" placeholder="Enter value">
                        </div>
                        <div class="form-group col-md-12">
                            <label>Aeps Code</label>
                            <input type="text" name="aepscode" class="form-control" placeholder="Enter value">
                        </div>
                    </div>
                </div>
...
@push('script')
                ...
                render:function(data, type, full, meta){
                    var menu = ``;
                        menu += `<li class="dropdown-header">Setting</li>
                                <li><a href="javascript:void(0)" onclick="editSetup('`+full.id+`', '`+full.companyname+`', '`+full.website+`', '`+full.companycode+`', '`+full.aepscode+`')"><i class="icon-pencil5"></i> Edit</a></li>`;
    ...
    function editSetup(id, companyname, website, companycode, aepscode){
        ...
        $('#setupModal').find('input[name="companycode"]').val(companycode);
        $('#setupModal').find('input[name="aepscode"]').val(aepscode);
        $('#setupModal').modal('show');
    }
</script>
@endpush