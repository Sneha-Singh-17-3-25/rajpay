                        ...
                        <div class="modal-body p-0" style="margin-bottom:20px">
                            ...
                            <table class="table table-bordered m-0">
                                <thead>
                                    ...
                                    <th>Whitelable
                                        <input type="number" step="any" onkeyup ="SETVALUE(this, 'whitelable')" class="form-control" placeholder="Enter Value">
                                    </th>
                                    <th>Master Distributor
                                        <input type="number" step="any" onkeyup ="SETVALUE(this, 'md')" class="form-control" placeholder="Enter Value">
                                    </th>
                                    <th>Distributor
                                        <input type="number" step="any" onkeyup ="SETVALUE(this, 'distributor')" class="form-control" placeholder="Enter Value">
                                    </th>
                                    <th>Retailer
                                        <input type="number" step="any" onkeyup ="SETVALUE(this, 'retailer')" class="form-control" placeholder="Enter Value">
                                    </th>
                                </thead>
                                ...
                                <tbody>
                                    @foreach ($value as $element)
                                        <tr>
                                            ...
                                            @endif
                                            <td class="p-t-0 p-b-0">
                                                <input type="number" step="any" name="whitelable[]" placeholder="Enter Value" class="form-control" >
                                            </td>
                                            <td class="p-t-0 p-b-0">
                                                <input type="number" step="any" name="md[]" placeholder="Enter Value" class="form-control" >
                                            </td>
                                            <td class="p-t-0 p-b-0">
                                                <input type="number" step="any" name="distributor[]" placeholder="Enter Value" class="form-control" >
                                            </td>
                                            <td class="p-t-0 p-b-0">
                                                <input type="number" step="any" name="retailer[]" placeholder="Enter Value" class="form-control" >
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
