...
@php
    $table = "yes";
    $search = "hide";
    $category = ["electricity", "broadband", "water", "postpaid", "lpggas", "gasutility", "loanrepay", "muncipal", "housing", "insurance"];
@endphp
            ...
            <div class="tab-pane active" id="recharge">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h5 class="panel-title">Bill Payment</h5>
                    </div>

                    <form id="billpayForm" action="{{route('selfbillpay')}}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="panel-body">
                            ...
                            @if ($mydata['billnotice'] != '' && $mydata['billnotice'] != null)
                                <h6 class="text-danger">Note : {{$mydata['billnotice']}}</h6>
                            @endif
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $(window).load(function () {
                SETTITLE("electricity", "billpayForm", "offline")
            });

            var url = "{{route('reportstatic')}}";
            $("[name='dataType']").val("offlinebillpay");
        ...
        function getname(type="none", form) {
            ...
            var url = "{{route('offlinebillpayFetch')}}";
                    ...
                    if(data.statuscode == "TXN"){
                        ...
                        $('#billpayForm').find('.billdata').append(`
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="biller" placeholder="Enter value" required="" value="`+data.data.customername+`">
                                <b>
                            </div>`);
                        ...
                        $('#billpayForm').find('.billdata').append(`
                            <div class="form-group col-md-4">
                                <label>Duedate</label>
                                <input type="text" class="form-control" name="duedate" placeholder="Enter value" required="" value="`+data.data.duedate+`">
                                <b>
                            </div>`);
                        ...
                        $('#billpayForm').find('.billdata').append(`
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control amount" name="amount" readonly="" placeholder="Enter amount" required="" value="`+data.data.dueamount+`">
                            </div>`);
                        ...
                        $('#billpayForm').find('.billdata').append(`
                            <div class="form-group col-md-4">
                                <label>Customer Name</label>
                                <input type="text" class="form-control" name="biller" placeholder="Enter value" required="" value="">
                                <b>
                            </div>`);
                        ...
                        $('#billpayForm').find('.billdata').append(`
                            <div class="form-group col-md-4">
                                <label>Duedate</label>
                                <input type="text" class="form-control" name="duedate" placeholder="Enter value" required="" value="">
                                <b>
                            </div>`);
                        ...
                        $('#billpayForm').find('.billdata').append(`
                            <div class="form-group col-md-4">
                                <label>Amount</label>
                                <input type="text" class="form-control amount" name="amount" placeholder="Enter amount" required="" value="">
                                <b>
                            </div>`);
                    }
                })
