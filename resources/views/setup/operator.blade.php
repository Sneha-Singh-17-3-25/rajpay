            ...
            <form id="setupManager" action="{{route('setupupdate')}}" method="post">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label>Bill Parameter Name (For Bbps Operator)</label>
                            <input type="text" name="paramname" class="form-control" placeholder="Enter value">
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        var onDraw = function() {
            ...
            $('.editOperator').on('click', function () {
                ...
                $('#setupModal').find('input[name="recharge3"]').val(data.recharge3);
                $('#setupModal').find('input[name="paramcount"]').val(data.paramcount);
                $('#setupModal').find('input[name="manditcount"]').val(data.manditcount);
                $('#setupModal').find('input[name="paramname"]').val(data.paramname);
                $('#setupModal').find('input[name="ismandatory"]').val(data.ismandatory);
                $('#setupModal').find('input[name="minlength"]').val(data.minlength);
                $('#setupModal').find('input[name="maxlength"]').val(data.maxlength);
