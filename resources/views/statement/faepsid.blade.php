@extends('layouts.app')
@section('title', "F-Aeps Agents List")
@section('pagetitle',  "F-Aeps Agent List")
            ...
            <div class="modal-content">
                ...
                <form id="editUtiidForm" action="{{route('statementUpdate')}}" method="post">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="actiontype" value="faepsid">
                        {{ csrf_field() }}
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="everify" class="form-control select" required>
                                    <option value="">Select Type</option>
                                    <option value="pending">Pending</option>
                            ...
                            <div class="form-group col-md-6">
                                <label>Aadhar</label>
                                <input type="text" name="merchantAadhar" value="" class="form-control" placeholder="" required="">
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label>Pancard</label>
                                <input type="text" name="userPan" class="form-control" value="" placeholder="" required="">
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label>Merchant Name</label>
                                <input type="text" name="merchantName" class="form-control" value="" placeholder="" required="">
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label>Merchant Phone Number</label>
                                <input type="text" name="merchantPhoneNumber" class="form-control" value="" placeholder="" required="">
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label>Remark</label>
                                <input type="text" name="remark" class="form-control" value="" placeholder="" required="">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = "{{url('statement/list/fetch')}}/faepsagentstatement/{{$id}}";
        var onDraw = function() {
            ...
            $('#datatable').on('click', '#agentEdit', function () {
                ...
                $('#editModal').find('[name="everify"]').val(data.everify).trigger('change');
                $('#editModal').find('[name="merchantPhoneNumber"]').val(data.merchantPhoneNumber);
                $('#editModal').find('[name="merchantAadhar"]').val(data.merchantAadhar);
                $('#editModal').find('[name="userPan"]').val(data.userPan);
                $('#editModal').find('[name="merchantName"]').val(data.merchantName);
                $('#editModal').find('[name="remark"]').val(data.remark);
                $("#editModal").modal();
            });
        };
