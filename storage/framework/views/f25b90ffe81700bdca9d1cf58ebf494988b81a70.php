                        ...
                        <div class="row text-center">
                            ...
                            <?php if(Myhelper::hasRole(["admin"])): ?>
                                <div class="col-xs-2">
                                    ...
                                    <h5 class="text-semibold no-margin"><?php echo e($whitelable); ?></h5>
                            ...
                            <?php if(Myhelper::hasRole(["admin", "whitelable"])): ?>
                                <div class="col-xs-2">
                                    ...
                                    <h5 class="text-semibold no-margin"><?php echo e($md); ?></h5>
                                    <span class="text-muted text-size-small">Master Distributor</span>

                                    <?php if(Myhelper::hasRole(["whitelable"])): ?>
                                        <br><span class="text-muted text-size-small">Stock : <?php echo e(\Auth::user()->mstock); ?></span>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if(Myhelper::hasRole(["admin", "whitelable", "md"])): ?>
                                <div class="col-xs-2">
                                    ...
                                    <h5 class="text-semibold no-margin"><?php echo e($distributor); ?></h5>
                                    <span class="text-muted text-size-small">Distributor</span>

                                    <?php if(Myhelper::hasRole(["whitelable", "md"])): ?>
                                        <br><span class="text-muted text-size-small">Stock : <?php echo e(\Auth::user()->dstock); ?></span>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if(Myhelper::hasRole(["admin", "whitelable", "md", "distributor"])): ?>
                                <div class="col-xs-2">
                                    ...
                                    <h5 class="text-semibold no-margin"><?php echo e($retailer); ?></h5>
                                    <span class="text-muted text-size-small">Retailer</span>
                                    <?php if(Myhelper::hasRole(["whitelable", "md", "distributor"])): ?>
                                        <br><span class="text-muted text-size-small">Stock : <?php echo e(\Auth::user()->rstock); ?></span>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if(Myhelper::hasRole(["admin"])): ?>
                                <div class="col-xs-2">
                                    ...
                                    <h5 class="text-semibold no-margin"><?php echo e($apiuser); ?></h5>
                            ...
                            <?php if(Myhelper::hasRole(["admin"])): ?>
                                <div class="col-xs-2">
                                    ...
                                    <h5 class="text-semibold no-margin"><?php echo e($other); ?></h5>
    ...
    <?php if(Myhelper::hasNotRole('admin')): ?>
        <div class="content pt-20 p-b-0">
            ...
            <?php if(Myhelper::hasNotRole('admin')): ?>
                <div class="row">
                    <div class="col-sm-3 col-md-2 col-xl-2">
                        <a href="<?php echo e(route('reports', ['type' => 'aeps'])); ?>" class="text-white">
                    ...
                    <div class="col-sm-3 col-md-2 col-xl-2">
                        <a href="<?php echo e(route('reports', ['type' => 'offlinebillpay'])); ?>" class="text-white">
                            <div class="panel panel-body bg-teal-600 border-left-xlg cursor-pointer mb-5" style="padding: 10px 10px;">
                                <div class="media no-margin">
                                    <div class="media-body">
                    ...
                    <div class="col-sm-3 col-md-2 col-xl-2">
                        <a href="<?php echo e(route('reports', ['type' => 'recharge'])); ?>" class="text-white">
                            <div class="panel panel-body bg-teal-600 border-left-xlg cursor-pointer mb-5" style="padding: 10px 10px;">
                                <div class="media no-margin">
                                    <div class="media-body">
                    ...
                    <div class="col-sm-3 col-md-2 col-xl-2">
                        <a href="<?php echo e(route('reports', ['type' => 'money'])); ?>" class="text-white">
                            <div class="panel panel-body bg-teal-600 border-left-xlg cursor-pointer mb-5" style="padding: 10px 10px;">
                                <div class="media no-margin">
                                    <div class="media-body">
                    ...
                    <div class="col-sm-3 col-md-2 col-xl-2">
                        <a href="<?php echo e(route('reports', ['type' => 'matm'])); ?>" class="text-white">
                            <div class="panel panel-body bg-teal-600 border-left-xlg cursor-pointer mb-5" style="padding: 10px 10px;">
                                <div class="media no-margin">
                                    <div class="media-body">
                    ...
                    <div class="col-sm-3 col-md-2 col-xl-2">
                        <a href="<?php echo e(route('reports', ['type' => 'pancard'])); ?>" class="text-white">
                            <div class="panel panel-body bg-teal-600 border-left-xlg cursor-pointer mb-5" style="padding: 10px 10px;">
                                <div class="media no-margin">
                                    <div class="media-body">
                                        <i class="fa fa-inr pull-left" style="padding:5px 0px;"></i>
            ...
            <div class="row">
                    ...
                    <a href="<?php echo e(route("aeps")); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/aeps.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route("aadharpay")); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/aadharpayicon.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route("dmt1")); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/dmt.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route('account', ['type' => 'nps'])); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/pension.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route('fund', ['type' => 'aeps'])); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/payout.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route('pancard' , ['type' => 'nsdl'])); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/pancard.svg")); ?>" alt="" style="width: 50px; height: 50px;">
            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route('recharge' , ['type' => 'mobile'])); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/mobile.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route('recharge' , ['type' => 'dth'])); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/dth.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route('recharge', ["type" => "fasttag"])); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/fasttag.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route('recharge', ["type" => "cabletv"])); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/cabletv.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route('bill' , ['type' => 'electricity'])); ?>}">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/electricity.svg")); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="col-sm-3 col-md-2 col-xl-2">
                    <a href="<?php echo e(route('bill' , ['type' => 'loanrepay'])); ?>">
                        <div class="panel">
                            <div class="panel-body text-center">
                                <img src="<?php echo e(asset("assets/svgicon/loanrepay.svg")); ?>" alt="" style="width: 50px; height: 50px;">
    ...
    <?php if(Myhelper::hasRole('admin')): ?>
        <div class="content pt-20" >
            <div class="row">
                ...
                <div class="col-sm-2 col-xl-2">
                    <a href="<?php echo e(route('reports', ['type' => 'aadharpay'])); ?>" class="text-white">
                        <div class="panel panel-body border-left-success border-left-xlg cursor-pointer mb-5" style="padding: 10px 10px;">
                            <div class="media no-margin">
                                <div class="media-body">
            ...
            <div class="row">
                <div class="col-sm-2 col-xl-2">
                    <a href="<?php echo e(route('reports', ['type' => 'billpay'])); ?>" class="text-white">
                        <div class="panel panel-body border-left-success border-left-xlg cursor-pointer mb-5" style="padding: 10px 10px;">
                            <div class="media no-margin">
                                <div class="media-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-2 col-xl-2">
                    <a href="<?php echo e(route('reports', ['type' => 'dmt'])); ?>" class="text-white">
                        <div class="panel panel-body border-left-success border-left-xlg cursor-pointer mb-5" style="padding: 10px 10px;">
                            <div class="media no-margin">
                                <div class="media-body">
                                    <i class="fa fa-inr pull-left" style="padding:5px 0px;"></i><h5 class="media-heading text-semibold dmtsuccessamt"></h5>
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            url: "<?php echo e(url('useronboard')); ?>",
            type: "POST",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
